...
baseBuffer.prototype.Absolutestate = function(dimension) {	//&& my added prototype, get bufferstate in dimension of bytes or second

	if(dimension == "bytes")
	{
	
		return this.fillState.bytes;
