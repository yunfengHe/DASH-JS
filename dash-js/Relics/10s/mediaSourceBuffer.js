...
function init_mediaSourceBuffer(bufferId, criticalLevel,buffersize, mediaAPI, videoElement, playbackTimePlot)
{
  ...
  _mediaSourceBuffer.initBufferArray("seconds",10);
  ...
  _mediaSourceBuffer.playbackTimePlot = playbackTimePlot;
	_mediaSourceBuffer.registerEventHandler("minimumLevel", _mediaSourceBuffer.signalRefill);  //$$ baseBuffer.prototype.registerEventHandler = function(event, handler)
