...
function DASH_MPD_loaded()
{
	  ...
	  ********************************************************************************/
	  //XX adaptation = init_rateBasedAdaptation(dashInstance.mpdLoader.mpdparser.pmpd, dashInstance.videoTag, myBandwidth);	//-- //XX  original
	  ...
	  adaptation = init_RateWatermarkAdaptationGear(dashInstance.mpdLoader.mpdparser.pmpd, dashInstance.videoTag, myBandwidth,overlayBuffer); //++ //XX 
